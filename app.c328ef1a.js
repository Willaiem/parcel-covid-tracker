    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , axios_1.default.get("https://covid-api.com/api/regions")];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          if (!(countryISO !== "total")) return [3
          /*break*/
          , 2];
          return [4
          /*yield*/
          , axios_1.default.get("https://covid-api.com/api/reports?date=" + date + "&iso=" + countryISO)];
        ...
        case 2:
          return [4
          /*yield*/
          , axios_1.default.get("https://covid-api.com/api/reports/total?date=" + date)];
...
var selectAllCounters = function () {
  var counterElsList = [];
  var quartersElements = document.querySelectorAll(".w3-quarter"); // for (const quarter of quartersElements as any) {
...
var fillFilterWithCountriesData = function () {
  return __awaiter(void 0, void 0, void 0, function () {
...
filterByCountriesSelectEl.addEventListener("change", function (event) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , getCovidReport(selectedCountryISO)];
...
var updateCounters = function (_a) {
  var active = _a.active,
      ...
      deaths = _a.deaths,
      recovered = _a.recovered;

  var _b = selectAllCounters(),
      activeCounter = _b[0],
      confirmedCounter = _b[1],
      deathsCounter = _b[2],
      recoveredCounter = _b[3];
